...
class ProjectsGalleryController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "projects_gallery";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Layihələrin Qalereyası";

        //      geri butonuna basanda hansi linke geri atsin
        $this->prev_link = base_url("ProjectsController");
