...
class SubServicesController extends MY_Controller{
    ...
    public function __construct()
    {
        ...
        //      tablemizin adi
        $this->table_name = "sub_service";

        //      tablemizin az dilinde adi
        $this->table_name_in_azeri = "Alt xidmətlər";
        ...
        $this->prev_link = base_url("ServicesController");
    ...
    public function get_data()
    {
        ...
        $config["additional_links"] = array(
            "Galereya" => "SubServicesGalleryController/index/",
        );
        $config["table_name"] = $this->table_name;
